...
ActiveRecord::Schema.define(version: 20_170_606_112_608) do
  ...
  create_table 'attempts', force: :cascade do |t|
    ...
    t.index ['interview_id'], name: 'index_attempts_on_interview_id', using: :btree
    t.index ['poll_id'], name: 'index_attempts_on_poll_id', using: :btree
  ...
  create_table 'payments', force: :cascade do |t|
    ...
    t.datetime 'created_at',                 null: false
    t.datetime 'updated_at',                 null: false
    t.index ['product_id'], name: 'index_payments_on_product_id', using: :btree

...
/ip hotspot profile set gyc-hotspot use-radius="yes" login-by="http-pap,https" ssl-certificate=gyc-ssl-cert html-directory=$GYChotspotRoot hotspot-address=$GYChotspotGuestNetworkHost dns-name=$GYChotspotRouterLocalName trial-uptime-limit=20s trial-uptime-reset=4s
